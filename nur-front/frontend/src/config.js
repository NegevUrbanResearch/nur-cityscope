...
const config = {
  ...
  api: {
    ...
    endpoints: {
      ...
      climateData: "climate/climate_data.csv",
    },
    // Get the full URL for the dashboard feed
    getDashboardFeedUrl: () =>
      `${config.api.baseUrl}${config.api.endpoints.dashboardFeed}`,
  },
  ...
  map: {
    ...
    accessToken:
      ...
      "pk.eyJ1Ijoibm9hbWpnYWwiLCJhIjoiY20zbHJ5MzRvMHBxZTJrcW9uZ21pMzMydiJ9.B_aBdP5jxu9nwTm3CoNhlg",
