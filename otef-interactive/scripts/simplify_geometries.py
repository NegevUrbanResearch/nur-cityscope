...
def main():
    ...
    parcels_input = project_root / "data-source" / "layers" / "migrashim.json"
    parcels_output = project_root / "data-source" / "layers-simplified" / "migrashim_simplified.json"
    ...
    roads_input = project_root / "data-source" / "layers-fixed" / "small_roads_fixed.json"
    roads_output = project_root / "data-source" / "layers-simplified" / "small_roads_simplified.json"
    ...
    print("- Use '../data-source/layers-simplified/migrashim_simplified.json'")
    print("- Use '../data-source/layers-simplified/small_roads_simplified.json'")
