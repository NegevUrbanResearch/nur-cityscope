...
const MESSAGES = {
  he: {
    ...
    basemapSatelliteColor: "\u05e6\u05d1\u05e2",
    basemapSatelliteBw: "\u05e9\u05d7\u05d5\u05e8\u05be\u05dc\u05d1\u05df",
    basemapSatelliteVariantsAria: "\u05e1\u05d5\u05d2 \u05ea\u05e6\u05dc\u05d5\u05dd \u05dc\u05d5\u05d5\u05d9\u05d9\u05df",
    basemapDark: "\u05db\u05d4\u05d4",
    nliNarrativesTitle: "\u05e0\u05e8\u05d8\u05d9\u05d1\u05d9\u05dd",
    nliNarrativeSegev: "\u05de\u05e9\u05e4\u05d7\u05ea \u05e9\u05d2\u05d1",
    nliNarrativeSegevAria: "\u05d4\u05e4\u05e2\u05dc\u05d4 \u05d0\u05d5 \u05e1\u05d9\u05d5\u05dd \u05e9\u05dc \u05e0\u05e8\u05d8\u05d9\u05d1 \u05de\u05e9\u05e4\u05d7\u05ea \u05e9\u05d2\u05d1",
    nliNarrativeNova: "\u05e0\u05d5\u05d1\u05d4",
    nliNarrativeNovaAria: "\u05d4\u05e4\u05e2\u05dc\u05d4 \u05d0\u05d5 \u05e1\u05d9\u05d5\u05dd \u05e9\u05dc \u05e0\u05e8\u05d8\u05d9\u05d1 \u05e0\u05d5\u05d1\u05d4",
    nliNarrativeSderot: "שדרות",
    ...
    nliNovaEscapeIndividual: "צירי בריחה",
    nliNovaEscapeOverlap: "צירי בריחה לפי צפיפות",
    nliNovaEscapeTogglesAria: "שכבות בדיקה לצירי הבריחה מנובה, לא מסלולי הישרדות",
    peopleNarrativeDisabled: "\u05d1\u05d7\u05d9\u05e8\u05ea \u05d0\u05d3\u05dd \u05d0\u05d9\u05e0\u05d4 \u05d6\u05de\u05d9\u05e0\u05d4 \u05d1\u05d6\u05de\u05df \u05e0\u05e8\u05d8\u05d9\u05d1",
    ...
    settlementsMode: "יישובים",
    peopleMode: "אנשים",
    peopleModeAria: "בחירת סוג חיפוש",
    peopleSearchPlaceholder: "חיפוש אדם",
    peopleSearchAria: "חיפוש אדם",
    peopleSuggestionsAria: "הצעות אנשים",
    peopleSearchLoading: "טוען אנשים…",
    peopleSearchUnavailable: "חיפוש האנשים אינו זמין",
    peopleSearchDisconnected: "אין חיבור למפה",
    peopleSearchEmpty: "לא נמצאו אנשים",
    peopleSearchStopping: "עוצר את חקירת ה-NLI…",
    peopleSearchStopFailed: "לא ניתן לעצור את חקירת ה-NLI; האדם לא נבחר",
    peopleSearchSelecting: "בוחר אדם…",
    peopleSearchSelectionFailed: "לא ניתן לבחור את האדם",
    peopleSearchClearing: "מנקה את בחירת האדם…",
    peopleSearchClearFailed: "לא ניתן לנקות את בחירת האדם",
    openNliRecord: "פתיחת ארכיון הספרייה",
    backToMap: "חזרה למפה",
    nliRecordMissing: "לא נמצאה רשומת NLI",
    nliArchiveUnavailable: "לא ניתן לפתוח את רשומת NLI",
    nliArchiveOpening: "פותח את רשומת NLI…",
    nliArchiveClosing: "סוגר את ארכיון NLI…",
    dialogClose: "סגירה",
    zoomLabel: "זום:",
    ...
    slideshowIntervalSecShort: "מרווח",
    slideshowCrossfadeSecShort: "מיזוג",
    slideshowWarmupLeadSecShort: "הכנה",
    slideshowKeepSettlementNames: "שמות יישובים",
    ariaSlideshowKeepSettlementNames: "הצגת שמות יישובים בכל החבילות",
    ...
    pinkLineLayerLabel: "קו ורוד",
    layersOpenPack: "הצג",
    layersPackActiveCount: "{{e}}/{{t}}",
    ariaLayerAnimationToggle: "הפעלת או כיבוי אנימציית זרימה לשכבה",
    ariaNliTimelinePlay: "ניגון ציר הזמן",
    ariaNliTimelinePause: "השהיית ציר הזמן",
    ariaNliTimelineStop: "עצירת ציר הזמן",
    ariaNliTimelineLoop: "חזרה על ציר הזמן",
    ariaNliTimelineStepBack: "פעימה אחורה",
    ariaNliTimelineStepForward: "פעימה קדימה",
    ariaNliTimelineScrub: "גרירת ציר הזמן",
    nliTimelinePaused: "ציר הזמן מושהה",
  ...
  en: {
    ...
    basemapSatelliteColor: "Color",
    basemapSatelliteBw: "B&W",
    basemapSatelliteVariantsAria: "Satellite imagery type",
    basemapDark: "Dark",
    nliNarrativesTitle: "Narratives",
    nliNarrativeSegev: "Segev family",
    nliNarrativeSegevAria: "Activate or end the Segev family narrative",
    nliNarrativeNova: "Nova",
    nliNarrativeNovaAria: "Activate or end the Nova narrative",
    nliNarrativeSderot: "Sderot",
    ...
    nliNovaEscapeIndividual: "Fleeing routes",
    nliNovaEscapeOverlap: "Fleeing density (overlap count)",
    nliNovaEscapeTogglesAria: "Test layers for routes from Nova, not survival paths",
    peopleNarrativeDisabled: "Person selection is unavailable while a narrative is active",
    ...
    settlementsMode: "Settlements",
    peopleMode: "People",
    peopleModeAria: "Search type",
    peopleSearchPlaceholder: "Search person",
    peopleSearchAria: "Search person",
    peopleSuggestionsAria: "People suggestions",
    peopleSearchLoading: "Loading people…",
    peopleSearchUnavailable: "People search is unavailable",
    peopleSearchDisconnected: "Map is disconnected",
    peopleSearchEmpty: "No people found",
    peopleSearchStopping: "Stopping the NLI investigation…",
    peopleSearchStopFailed: "Could not stop the NLI investigation; person not selected",
    peopleSearchSelecting: "Selecting person…",
    peopleSearchSelectionFailed: "Could not select person",
    peopleSearchClearing: "Clearing person selection…",
    peopleSearchClearFailed: "Could not clear person selection",
    openNliRecord: "Open NLI record",
    backToMap: "Back to map",
    nliRecordMissing: "No NLI record found",
    nliArchiveUnavailable: "Could not open the NLI record",
    nliArchiveOpening: "Opening NLI record…",
    nliArchiveClosing: "Closing NLI archive…",
    dialogClose: "Close",
    zoomLabel: "Zoom:",
    ...
    slideshowIntervalSecShort: "Interval",
    slideshowCrossfadeSecShort: "Crossfade",
    slideshowWarmupLeadSecShort: "Warmup",
    slideshowKeepSettlementNames: "Settlement names",
    ariaSlideshowKeepSettlementNames: "Show settlement names on all packs",
    ...
    pinkLineLayerLabel: "Pink line",
    layersOpenPack: "View",
    layersPackActiveCount: "{{e}}/{{t}}",
    ariaLayerAnimationToggle: "Enable or disable flow animation for this layer",
    ariaNliTimelinePlay: "Play timeline",
    ariaNliTimelinePause: "Pause timeline",
    ariaNliTimelineStop: "Stop timeline",
    ariaNliTimelineLoop: "Loop timeline",
    ariaNliTimelineStepBack: "Step back one beat",
    ariaNliTimelineStepForward: "Step forward one beat",
    ariaNliTimelineScrub: "Scrub timeline",
    nliTimelinePaused: "Timeline paused",
